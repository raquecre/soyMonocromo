        ...
        <div className="bg-black text-white p-5 ">
            ...
            <div className="flex md:flex-col sm:flex-row">
                ...
                <div className="flex flex-col">
                    <CardContact
                        textContact="admin@soymonocromo.com"
                        iconTypeContact={
                    ...
                    <div className="pattern-wavy pattern-yellow-500 pattern-bg-white pattern-size-6 pattern-opacity-20">
                ...
                <img src="https://i.imgur.com/W6QaLVt.png" alt="imageLogo" srcset="" />
